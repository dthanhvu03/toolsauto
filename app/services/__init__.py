...
_ALIASES = {
    ...
    "telegram_client": "app.features.telegram_bot.client",
    ...
    "strategic": "app.features.viral_intake.strategic",
    "fb_compliance": "app.features.facebook_publisher.compliance.fb_compliance",
    "compliance_service": "app.features.facebook_publisher.compliance.service",
