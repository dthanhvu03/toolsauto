...
SETTINGS: dict[str, SettingSpec] = {
    ...
    "THREADS_MAX_ARTICLE_AGE_HOURS": SettingSpec(
        ...
        title="Tuoi toi da cua bai tin",
        section="Threads Auto",
        description="Chi lay bai tin con moi trong so gio nay de tranh dang lai tin da nguoi.",
        min=1,
        max=72,
        unit="gio",
    ),
    "THREADS_TOPIC_DEDUP_HOURS": SettingSpec(
        ...
        title="Cua so dedup chu de",
        section="Threads Auto",
        description="Neu da co bai Threads cung topic_key trong so gio nay thi bo qua bai moi.",
        min=1,
        max=168,
        unit="gio",
    ),
    "THREADS_ACCOUNT_CATEGORY_MAP": SettingSpec(
        ...
        section="Threads Auto",
        description="JSON map account_id -> category de route tung account Threads theo nhom tin.",
    ),
