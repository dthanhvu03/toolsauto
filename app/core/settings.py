...
SETTINGS: dict[str, SettingSpec] = {
    ...
    "reup.subtitle_enabled": SettingSpec(
        ...
        title="Dot phu de tieng Viet",
        section="Reup - lop them",
        description="Dot phu de tieng Viet (Whisper) vao video reup. Mac dinh tat.",
    ),
    "reup.subtitle_font_size": SettingSpec(
        ...
        title="Co chu phu de",
        section="Reup - lop them",
        description="Co chu tinh tren khung 1080x1920 (libass tu scale theo video).",
        min=24,
        max=120,
        unit="px",
    ),
    "reup.subtitle_margin_v": SettingSpec(
        ...
        title="Khoang cach day phu de",
        section="Reup - lop them",
        description="Le duoi (MarginV) tren khung 1080x1920 de phu de khong de len thanh caption TikTok/Reels.",
        min=40,
        max=800,
        unit="px",
    ),
    "reup.audio_voice_enabled": SettingSpec(
        ...
        type="bool",
        default_getter=lambda: False,
        title="Voice-over doc hook text",
        section="Reup - lop them",
        description="Doc hook text bang TTS tieng Viet (edge-tts, du phong piper offline) tron vao video. Mac dinh tat.",
    ),
    "reup.audio_voice_name": SettingSpec(
        ...
        title="Giong doc",
        section="Reup - lop them",
        description="Giong edge-tts. HoaiMy = nu, NamMinh = nam.",
    ...
    "reup.audio_voice_engine": SettingSpec(
        ...
        title="Engine TTS",
        section="Reup - lop them",
        description="auto = edge-tts truoc, hong thi piper offline (model trong storage/media/tts_models/).",
    ...
    "reup.audio_music_enabled": SettingSpec(
        ...
        title="Nhac nen",
        section="Reup - lop them",
        description="Chon ngau nhien 1 file trong storage/media/music/ (Owner tu tai — Meta Sound Collection chi dung tren Facebook). Mac dinh tat.",
    ),
    "reup.audio_music_volume": SettingSpec(
        key="reup.audio_music_volume",
        type="str",
        default_getter=lambda: "0.12",
        title="Am luong nhac nen",
        section="Reup - lop them",
        description="0.0 - 1.0",
    ),
